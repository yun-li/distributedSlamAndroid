...
#ifndef LOGI
#define LOGI(...) ((void)__android_log_print(ANDROID_LOG_INFO, "LIBOPENCLSTUB", __VA_ARGS__))
#define LOGW(...) ((void)__android_log_print(ANDROID_LOG_WARN, "LIBOPENCLSTUB", __VA_ARGS__))
#endif
#else
...
static void open_libopencl_so()
{
    ...
    if(!path)
    {
        LOGI("Look for a real OpenCL library.");
